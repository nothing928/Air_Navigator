 ...
 */
public class OptionCircleRedView extends ImageView {
    ...
    public OptionCircleRedView(Context context) {
        this(context, null);
...
//        Log.e("circle","width = "+width+", height = "+height);
    ...
    public OptionCircleRedView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        this.paint = new Paint();
        this.paint.setAntiAlias(true);
        this.paint.setStyle(Paint.Style.STROKE);
        colorCircle = Color.RED;// 默认颜色
...
//            paint_nei.setStrokeWidth(3f);
            ...
            canvas.drawCircle(BaseScaleView.width_view/3, BaseScaleView.height_view/2,
                    MyApplication.getWidth()/40, this.paint);// 画外边框圆圈
            canvas.drawCircle(BaseScaleView.width_view/3, BaseScaleView.height_view/2,
                    MyApplication.getWidth()/40-BaseScaleView.width_view/90, paint_nei);// 画里面的填充圆圈
