...
public class ChartService {
     ...
     */
    double maxX;
    public void setXYMultipleSeriesRenderer(double maxX, double maxY, String chartTitle, String xTitle, String yTitle,
                                            int axeColor, int labelColor, int curveColor, int gridColor,
                                            int textsize) {
