 ...
 */
public class OptionCircleYellowView extends ImageView {
    ...
    public OptionCircleYellowView(Context context) {
        this(context, null);
...
//        Log.e("circle","width = "+width+", height = "+height);
    ...
    public OptionCircleYellowView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        this.paint = new Paint();
        this.paint.setAntiAlias(true);
        this.paint.setStyle(Paint.Style.STROKE);
        colorCircle = Color.YELLOW;// 默认颜色
